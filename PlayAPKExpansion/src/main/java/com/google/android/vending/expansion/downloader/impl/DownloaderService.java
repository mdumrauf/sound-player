...
import com.google.android.vending.expansion.downloader.IDownloaderNotifiableClient;
 ...
 */
public abstract class DownloaderService extends CustomIntentService implements IDownloaderService, IDownloaderClient {
    ...
    private IDownloaderNotifiableClient mNotification;
    ...
    public void onServiceConnected(Messenger m) {
      mNotification.onServiceConnected(m);
    }

    @Override
    public void onDownloadStateChanged(int newState) {
      mNotification.onDownloadStateChanged(newState);
    }

    @Override
    public void onDownloadProgress(DownloadProgressInfo progress) {
      mNotification.onDownloadProgress(progress);
    }
    ...
    private class LVLRunnable implements Runnable {
        ...
        public void run() {
            ...
            onDownloadStateChanged(IDownloaderClient.STATE_FETCHING_URL);
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            for (DownloadInfo info : infos) {
                ...
                if (info.mStatus != STATUS_SUCCESS) {
                    DownloadThread dt = new DownloadThread(info, this);
                    cancelAlarms();
                ...
                onDownloadStateChanged(notifyStatus);
                return;
            }
